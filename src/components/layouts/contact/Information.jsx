                                ...
                                <ul>
                                    <li className="clearfix">
                                        <div className="inner">
                                            ...
                                            <span className="text">1979/1, Lane No. 2, Ferozepur Rd, opposite Ansal Plaza, Maharaj Nagar, Ludhiana, Punjab 141001 </span>
                                        </div>
                                    </li>
                                    <li className="clearfix">
                                        <div className="inner">
                                            <span className="fa fa-phone" />
                                            <span className="text">CALL US : +91 87279 22330</span>
                                        </div>
                                    </li>
                                    <li className="clearfix">
                                        <div className="inner">
