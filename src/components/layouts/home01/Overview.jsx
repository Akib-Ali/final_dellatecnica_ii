            ...
            tab: [
                {
                    ...
                    item: [
                        {
                            idx: 1,
                            content: 'Quality: At Dellatecnica, we prioritize the quality of our wood working machines. ',
                        },
                        {
                            idx: 2,
                            content: 'Innovation: We constantly strive to innovate and improve our wood working machines.',
                        },
                        {
                            idx: 3,
                            content: 'Customer Satisfaction: Our customers are our top priority, and we want to satisfy with our products and services.',
                        },
                        {
                            idx: 4,
                            content: 'Sustainability: We are committed to using sustainable materials and practices in our manufacturing processes.',
                        },
                        // {
                        //     idx: 5,
                        //     content: 'Partnership: We view our customers as partners, and we work closely with them to understand their needs and goals.',
                        // }
                    ]
                },
                // {
